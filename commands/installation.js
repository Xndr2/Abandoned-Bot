    ...
    async execute(interaction, client) {
        if (client.cooldowns.has(interaction.user.id)) {
            ...
            const installEmbed = new MessageEmbed()
                ...
                .setDescription(
                    "There are 2 ways on how you can install the game.\n It is recommended to use the first one.\nGo to <#1066649511637811270> and scroll up or click [here](https://discord.com/channels/972478717232304138/1066649511637811270/1066659470983303249)."
                )
                .addField("Option 1:", "Automatic Installation [Recommended]", true)
